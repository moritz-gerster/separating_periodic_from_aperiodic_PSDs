...
from functions import osc_signals6
...
# Sim Toy Signal
toy_ground_a, toy_signal_a = osc_signals6(toy_slope,
                                         periodic_params=periodic_params_a,
                                         highpass=False)
toy_ground_b, toy_signal_b = osc_signals6(toy_slope,
                                         periodic_params=periodic_params_b,
                                         highpass=False)
toy_ground_c, toy_signal_c = osc_signals6(toy_slope,
...
xmin_a11, xmax_a11 = peak_width6(freq_a, toy_psd_a, ground_psd_a,
                                freq_range=range1)
xmin_a12, xmax_a12 = peak_width6(freq_a, toy_psd_a, ground_psd_a,
                                freq_range=range2)
xmin_a13, xmax_a13 = peak_width6(freq_a, toy_psd_a, ground_psd_a,
                                freq_range=range3)

xmin_a21, xmax_a21 = peak_width6(freq_a, toy_psd_b, ground_psd_b,
                                freq_range=range1)
xmin_a22, xmax_a22 = peak_width6(freq_a, toy_psd_b, ground_psd_b,
                                freq_range=range2)
xmin_a23, xmax_a23 = peak_width6(freq_a, toy_psd_b, ground_psd_b,
                                freq_range=range3)

xmin_a31, xmax_a31 = peak_width6(freq_a, toy_psd_c, ground_psd_c,
                                freq_range=range1)
xmin_a32, xmax_a32 = peak_width6(freq_a, toy_psd_c, ground_psd_c,
                                freq_range=range2)
xmin_a33, xmax_a33 = peak_width6(freq_a, toy_psd_c, ground_psd_c,
                                freq_range=range3)
...
fit_errors_a = calc_error6(toy_signal_a)
fit_errors_b = calc_error6(toy_signal_b)
fit_errors_c = calc_error6(toy_signal_c)
...
# Sim Toy Signal
noise_small, peak_small = osc_signals6(toy_slope,
                                      periodic_params=periodic_params_s,
                                      highpass=False, srate=srate_small)
noise_med, peak_med = osc_signals6(toy_slope,
                                  periodic_params=periodic_params_m,
                                  highpass=False, srate=srate_med)
noise_large, peak_large = osc_signals6(toy_slope,
...
xmin_small_min1, xmin_small_max1 = peak_width6(freq_small,
                                              peak_psd_small,
                                              noise_psd_small,
                                              freq_range=frange1)
xmin_small_min2, xmin_small_max2 = peak_width6(freq_small,
                                              peak_psd_small,
                                              noise_psd_small,
                                              freq_range=frange2)
xmin_med_min1, xmin_med_max1 = peak_width6(freq_med, peak_psd_med,
                                          noise_psd_med,
                                          freq_range=frange1)
xmin_med_min2, xmin_med_max2 = peak_width6(freq_med, peak_psd_med,
                                          noise_psd_med,
                                          freq_range=frange2)
xmin_large_min1, xmin_large_max1 = peak_width6(freq_large,
                                              peak_psd_large,
                                              noise_psd_large,
                                              freq_range=frange1)
xmin_large_min2, xmin_large_max2 = peak_width6(freq_large,
                                              peak_psd_large,
                                              noise_psd_large,
                                              freq_range=frange2)
