...
def osc_signals(slope=1, periodic_params=None, nlv=None,
                highpass=True, srate=2400, duration=180, seed=1):
    """
    ...
    highpass : bool, optional
        Apply 4th order butterworth highpass filter at 1Hz. If False,
        no filter will be applied. The default is True.
...
def osc_signals_old(slope, periodic_params=None, nlv=None,
                    highpass=True, srate=2400, duration=180, seed=1):
    ...
    noise_osc = np.fft.irfft(amps_osc)
...
# =============================================================================
# def noise_white(n_samples, seed=True):
...
periodic_params = [(4, 20, 0.1), (11, 20, 1), (23, 7, 2)]

signals = osc_signals_old(slope, periodic_params=periodic_params)
...
periodic_params = [(2.5, 1.5, 0.1), (3, 4.5, .7), (4, 5, 1.2), (7, 3, 20),
                   (27, 750, 7), (36, 500, 11), (360, 6000, 60)]
...
pure1, pink1 = osc_signals_old(slope, periodic_params=periodic_params,
                               nlv=nlv, highpass=highpass)
pink1 = pink1
pure = pure1
...
# oscillations
periodic_params = [(2.5, 7, .8), (3, 4.5, .7), (4, 5, 1.2), (7, 3, 20),
                   (27, 750, 7), (36, 500, 11), (360, 6000, 60)]


_, pink1_deltaHigh = osc_signals_old(slope, periodic_params=periodic_params,
                                     nlv=nlv, highpass=highpass)
pink1_deltaHigh = pink1_deltaHigh
...
periodic_params = [(2.5, 0, .8), (3, 0, .7), (4, 5, 1.2), (7, 3, 20),
                   (27, 750, 7), (36, 500, 11), (360, 6000, 60)]
_, pink1_deltaLow = osc_signals_old(slope, periodic_params=periodic_params,
                                    nlv=nlv, highpass=highpass)
...
periodic_params = [(2.5, 0, 0.1), (3, 0, .7), (4, 0, 1.2), (7, 0, 20),
                   (27, 0, 7), (36, 0, 11), (360, 0, 60)]
...
freq, sim1 = sig.welch(pink1, fs=srate, nperseg=nperseg, detrend=detrend)
freq, pure1 = sig.welch(pure1, fs=srate, nperseg=nperseg, detrend=detrend)
...
# oscillations
periodic_params = [(2.5, 0, .8), (3, 0, .7), (4, 0, 1.2), (7, 0, 20),
                   (27, 0, 7), (36, 0, 11), (360, 0, 60)]
...
ax.loglog(*ground, **ground_kwargs, label=f"Sim 1/f a={slope}")
ax.loglog(*low)
